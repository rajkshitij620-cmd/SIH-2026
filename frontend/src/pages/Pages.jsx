   ...
   <div>
    <div className="text-center max-w-2xl mx-auto">
     ...
     <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white">
      Why TourMitra AI stands ahead of conventional travel apps
     </h2>
 ...
 return <div className="shell max-w-4xl py-10 min-h-[85vh] flex flex-col justify-between">
  <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 pb-4 dark:border-slate-800">
   <div className="flex items-center gap-3">
    ...
    <div>
     <h1 className="text-xl font-bold bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent">TourMitra AI</h1>
  ...
  <div className="sticky bottom-4 mt-4">
   ...
   <p className="mt-2 text-center text-[11px] text-slate-400 dark:text-slate-500">TourMitra AI provides destination insights, real-time weather, authentic food recommendations, and travel budgets.</p>
  </div>
 </div>;
}
